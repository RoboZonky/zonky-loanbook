...
public final class SummaryInterestRateRelativeTimelineChart extends AbstractTimelineXYZChart {

    public SummaryInterestRateRelativeTimelineChart(final Data data) {
        super(data, SummaryInterestRateRelativeTimelineChart::interestRateDefaultTimeline);
    }
    ...
    private static void interestRateDefaultTimeline(final Stream<DataRow> data,
        ...
        final Tuple2<String, Function<List<DataRow>, Number>>[] series = all.keySet().stream()
                .map(SummaryInterestRateRelativeTimelineChart::convert)
    ...
    public String getTitle() {
        return "Skladba úrokových měr v čase podle počtu úvěrů";
    }
}
